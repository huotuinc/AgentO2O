 ...
 */
@Repository
public interface SettlementOrderRepository extends JpaRepository<SettlementOrder, Integer>,JpaSpecificationExecutor {
    SettlementOrder findByOrderId(String orderId);

    List<SettlementOrder> findBySettlement_Id(Integer settlementId);
}
